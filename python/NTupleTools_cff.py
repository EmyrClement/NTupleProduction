...
if options.CMSSW == "53X" and options.centreOfMassEnergy == 8:
    ...
    TEST_MC_FILE = 'file:///storage/ec6821/NTupleProd/CMSSW_5_3_20/src/Summer12_DR53X_TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola_AODSIM_PU_S10_START53_V7A-v1.root'
    ...
    TEST_DATA_FILE = 'file:///storage/TopQuarkGroup/test/TT_test.root' #test file for 2011 7TeV 53X RunA Oct2013 re-reco
    TEST_MC_FILE = 'file:/storage/ec6821/NTupleProd/CMSSW_5_3_20/src/TT_test.root'
